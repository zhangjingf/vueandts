...
var status = {
    ...
    sprites: {
        plugin: new SpritesmithPlugin({
            src: {
		        cwd: path.resolve(__dirname, '../vueandts/src/images/icons/'),
		        glob: '*.png'
		      },
		    target: {
		        image: path.resolve(__dirname, '../vueandts/src/images/sprite.png'),
		        css: [
		          [path.resolve(__dirname, '../vueandts/src/scss/sprites.scss'), {
